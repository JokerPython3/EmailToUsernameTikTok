...
class EmailToUsernameTikTok:
    def __init__(self, email: str, proxy: dict[str, str] | str | None = None) -> None:
        ...
        self.__xor_email = self.__xor(self.__email)
    ...
    def __get_param(self) -> dict:
        return {
            ...
            "fixed_mix_mode": "1",
            "mix_mode": "1",
            "account_param": self.__xor_email,
            "scene": "1",
            "device_platform": "android",
            "os": "android",
            "ssmix": "a",
        ...
        for host in hosts:
            try:
                response = await self.__client.post(
                    "https://" + host + "/passport/account_lookup/email/",
        ...
        try:
            ...
            if username == "Email Not found in TikTok":
                return {
                    ...
                    "username": "",
                    "email": self.__email,
                    "message": "Email Not found in TikTok",
                }
            return {"status": "success", "username": username, "email": self.__email}
        except Exception:
